    ...
    <div className="flex">
      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          <input type="text" className="ml-7 bg-green-100 rounded-md px-9 py-4 text-[19px] border" name="kelas_pemenang" value={kelasPemenang.kelas_pemenang} onChange={handleInputChange} placeholder="Kelas Pemenang" />
          <div className="mt-7 ml-7">
            <button type="submit" className=" px-5 py-3 bg-green-500 rounded font-bold text-[18px]">
              Submit
            </button>
          </div>
        </form>
